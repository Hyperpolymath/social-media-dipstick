...
procedure NUJ_TUI is
   ...
   begin
      ...
      IO.Put_Line ("  Collector (Julia): " & GREEN & "● RUNNING" & RESET & "  (3001)");
      IO.Put_Line ("  Analyzer (Python): " & GREEN & "● RUNNING" & RESET & "  (3002)");
      IO.Put_Line ("  Publisher (Node):  " & GREEN & "● RUNNING" & RESET & "  (3003)");
